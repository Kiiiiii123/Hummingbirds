...
/// <summary>
/// Manges a collection of flower plants and attached flowers.
/// </summary>
public class FlowerArea : MonoBehaviour
{
    ...
    /// <summary>
    /// Recursively find all flowers and flower plants that are children of a parent transform.
    /// </summary>
    ...
    private void FindChildFlowers(Transform parent)
    {
        for (int i = 0; i < parent.childCount; i++)
        {
            ...
            if (child.CompareTag("flower_plant"))
            {
                ...
                // Look for flower with the child plant.
